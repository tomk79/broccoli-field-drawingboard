...
var _tasks = [
	'broccoli-field-drawingboard.js'
];


// broccoli-field-drawingboard.js (frontend) を処理
gulp.task("broccoli-field-drawingboard.js", function() {
	gulp.src(["src/broccoli-field-drawingboard.js"])
		.pipe(plumber())
		.pipe(browserify({}))
